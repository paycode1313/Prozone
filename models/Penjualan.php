...
class Penjualan {
    ...
    public function create() {
        $query = "INSERT INTO " . $this->table_name . "
                  SET no_transaksi=:no_transaksi, user_id=:user_id, customer_id=:customer_id, 
                      ...
                      total_bayar=:total_bayar, kembalian=:kembalian, metode_pembayaran=:metode_pembayaran, note=:note";
        ...
        $this->metode_pembayaran = !empty($this->metode_pembayaran) ? htmlspecialchars(strip_tags($this->metode_pembayaran)) : 'CASH';
    ...
    public function readOne() {
        ...
        if ($stmt->rowCount() > 0) {
            ...
            $this->metode_pembayaran = $row['metode_pembayaran'] ?? 'CASH';
            $this->note = $row['note'];
